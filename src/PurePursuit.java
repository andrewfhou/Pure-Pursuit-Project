...
public class PurePursuit {
    ...
    public static void main(String[] args) {
        ...
        Point pt3 = new Point(20.0, 10.0);

        Line ln = new Line(pt1, pt2);

        Point pt2t = ln.rotate(pt2); //todo: fix this shit
        Point pt3t = ln.rotate(pt3);

        System.out.println("pt1: " + pt1 + "\tpt2: " + pt2);
        System.out.println("target heading: " + ln.angle + "\n");

        Line lnTwo = new Line(pt2t, pt3t);

        System.out.println("pt2t: " + pt2t + "\tpt3t" + pt3t);
        System.out.println("target heading: " + lnTwo.angle + "\n");
